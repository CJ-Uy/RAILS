/*
  ...
  - The values [NOT_APPLICABLE] on the enum `LaboratoryRequests_laboratoryReservationsAdminApproval` will be removed. If these variants are still used in the database, this will fail.
  - The values [NOT_APPLICABLE] on the enum `LaboratoryRequests_laboratoryReservationsAdminApproval` will be removed. If these variants are still used in the database, this will fail.
  - The values [NOT_APPLICABLE] on the enum `LaboratoryRequests_laboratoryReservationsAdminApproval` will be removed. If these variants are still used in the database, this will fail.
  - The values [NOT_APPLICABLE] on the enum `LaboratoryRequests_laboratoryReservationsAdminApproval` will be removed. If these variants are still used in the database, this will fail.
  - The values [NOT_APPLICABLE] on the enum `LaboratoryRequests_laboratoryReservationsAdminApproval` will be removed. If these variants are still used in the database, this will fail.
