...
const startingColumns = ["name", "description", "hidden"]; // Key of starting columns in list of all columns
...
async function updateChanges() {
    await useFetch("/api/admin/editForms/manageLocations/update", {
        method: "POST",
...
async function addNewItem() {
    await useFetch("/api/admin/editForms/manageLocations/add", {
        method: "POST",
...
async function deleteItem() {
    ...
    const deletion = await useFetch(
        "/api/admin/editForms/manageLocations/delete",
        {
            method: "POST",
            body: JSON.stringify(selectedData.value),
        },
...
<template>
    <div>
        ...
        <TablesWSlottedModals
            ...
            fetch-path="/api/db/rawData/getAllLocations"
            ...
            <template #addRecordModal>
                <UCard>
                    ...
                    >
                        ...
                        >
                            <UInput
                                v-if="!['name', 'unit'].includes(item.key)"
